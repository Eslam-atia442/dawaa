...
return [
    ...
    */
    'upload' => [
        ...
        'quality'   => 60,
        'paths' => [
            'slider' => $base_dir . DIRECTORY_SEPARATOR . 'slider' . DIRECTORY_SEPARATOR,
            'intro' => $base_dir . DIRECTORY_SEPARATOR . 'intro' . DIRECTORY_SEPARATOR,
            'social' => $base_dir . DIRECTORY_SEPARATOR . 'social' . DIRECTORY_SEPARATOR,
            'category' => $base_dir . DIRECTORY_SEPARATOR . 'category' . DIRECTORY_SEPARATOR,
            'Admin' => $base_dir . DIRECTORY_SEPARATOR . 'admin' . DIRECTORY_SEPARATOR,
            ...
            'setting' => $base_dir . DIRECTORY_SEPARATOR . 'setting' . DIRECTORY_SEPARATOR,
