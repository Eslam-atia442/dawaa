        ...
        <div class="row g-0">
            ...
            <div class="col-md-9">
                <div class="card-body p-4">
                    <form class="form validated-form" method="POST"
                          action="{{route('admin.cities.update' , ['city' => $row->id])}}" novalidate
                        ...
                        <div class="pt-4 d-flex justify-content-center mt-3">
                            ...
                            <a class="btn btn-label-dribbble waves-effect"
                               href="{{ url()->previous()}}">@lang('trans.back')</a>
                        </div>
                    </form>
                </div>
            </div>
