    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                ...
                <a href="{{route('admin.cities.index')}}">@lang('trans.city.index')</a>
            </li>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-9">
                <div class="card-body p-4">
                    <form class="form validated-form" method="POST" action="{{route('admin.cities.store')}}" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel" aria-labelledby="v-pills-general-tab" tabindex="0">
                                <div class="row g-3">
                                    ...
                                    @endforeach
                                    <x-admin.input
                                        name="region_id"  label="region.index"
                                        type="select"  col="col-xl-6"  placeholder="region.index"
                                        :options="$regions"
                                    />
                                </div>
                            </div>
