...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> <i class="ti ti-contrast-2 me-2"></i> {{$title}}</li>
        </ol>
    </nav>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <x-admin.buttons
                extrabuttons="true"
                 createPermission="create-slider"
                :addbutton="route('admin.sliders.create')"
                 deletePermission="delete-slider"
                 :deletebutton="route('admin.sliders.destroy-multiple')"
            >
                <x-slot name="extrabuttonsdiv">
                    @can('create-export')
                        <x-admin.export-button 
                            :route="route('admin.slider-export')"
                            buttonId="exportSliderBtn"
...
@push('js_files')
    ...
    @include('dashboard.shared.filter_js' , [ 'index_route' => route('admin.sliders.index') ])
@endpush
