        ...
        <div class="row g-0">
            ...
            <div class="col-md-9">
                <div class="card-body p-4">
                    <form class="form validated-form" method="POST" action="{{route('admin.stores.update' , ['store' => $row->id])}}" novalidate enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel" aria-labelledby="v-pills-general-tab" tabindex="0">
                                <div class="row g-3">
                                    ...
                                    <x-admin.input
                                        ...
                                        :options="$regions->map(fn($r) => ['id' => $r->id, 'name' => $r->name])->toArray()"
                                    />
                                    <x-admin.input
                                        name="city_id"
                                        label="city.index"
                                        ...
                                        id="city_id"
                                        :value="$row->city_id"
                                        :options="$cities->map(fn($c) => ['id' => $c->id, 'name' => $c->name])->toArray()"
                                    />
                                </div>
                            </div>
