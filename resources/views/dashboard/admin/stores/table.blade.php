        ...
        <tr class="delete_row">
            ...
            <td>
                <div class="d-inline-block text-nowrap">
                   @can('update-store')
                    <a href="{{ route('admin.stores.edit', ['store' => $row->id]) }}" class="btn btn-sm btn-icon"><i class="text-primary ti ti-edit"></i></a>
                   @endcan
                    <a href="{{ route('admin.stores.show' , ['store' => $row->id])  }}" class="btn btn-sm btn-icon"><i class="text-info ti ti-eye-check"></i></a>
                   @can('delete-store')
                    <a class="btn btn-sm btn-icon delete-row" data-url="{{ route('admin.stores.destroy', $row->id)  }}"><i class="text-danger ti ti-trash-x"></i></a>
                   @endcan
                </div>
            </td>
