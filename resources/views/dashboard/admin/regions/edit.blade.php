...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <i class="ti ti-directions me-2"></i>
                <a href="{{route('admin.regions.index')}}">@lang('trans.region.index')</a>
            </li>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-9">
                <div class="card-body p-4">
                    <form class="form validated-form" method="POST" action="{{route('admin.regions.update' , ['region' => $row->id])}}" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel" aria-labelledby="v-pills-general-tab" tabindex="0">
                                <div class="row g-3">
                                    ...
                                    @endforeach
                                    <x-admin.input
                                        required="true" :value="$row->country->id ?? ''" name="country_id" label="country.index"
                                        type="select" col="col-xl-6" placeholder="country.index"
                                        :options="$countries"
                                    />
                                </div>
                            </div>
