...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <i class="ti ti-category-2 me-2"></i>
                <a href="{{route('admin.categories.index')}}">@lang('trans.category.index')</a>
            </li>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-9">
                <div class="card-body p-4">
                    <form class="form validated-form" method="POST" action="{{route('admin.categories.update' , ['category' => $row->id])}}" novalidate enctype="multipart/form-data">
                        @csrf
