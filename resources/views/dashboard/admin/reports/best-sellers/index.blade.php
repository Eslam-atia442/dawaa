...
@section('title')
{{$title = __('trans.best_seller_report')}}
@endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> <i class="ti ti-chart-bar me-2"></i> {{$title}}</li>
    </ol>
</nav>
        ...
        <x-admin.buttons
            ...
            <x-slot name="extrabuttonsdiv">
                ...
                <x-admin.export-button
                    :route="route('admin.reports.best-sellers.export')"
                    buttonId="exportBestSellerBtn"
...
@push('js_files')
@include('dashboard.shared.filter_js' , [ 'index_route' => route('admin.reports.best-sellers.index') ])
@endpush
