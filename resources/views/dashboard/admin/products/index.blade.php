...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> <i class="ti ti-medicine-syrup me-2"></i> {{$title}}</li>
        </ol>
    </nav>
        ...
        <div class="card-header">
            ...
            <x-admin.buttons
                ...
                :addbutton="route('admin.products.create')"
                 ...
                 :deletebutton="route('admin.products.destroy-multiple')"
            >
                <x-slot name="extrabuttonsdiv">
                    @can('create-export')
                        <x-admin.export-button 
                            :route="route('admin.product-export')"
                            buttonId="exportProductBtn"
...
@push('js_files')
    ...
    @include('dashboard.shared.filter_js' , [ 'index_route' => route('admin.products.index') ])
@endpush
