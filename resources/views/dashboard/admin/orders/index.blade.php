...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> <i class="ti ti ti-bolt me-2"></i> {{$title}}</li>
    </ol>
</nav>
...
<div class="card">
    <div class="card-header">
        ...
        <x-admin.buttons
            extrabuttons="true"
            createPermission="create-order"
            :addbutton="route('admin.orders.create')"
            deletePermission="delete-order"
            :deletebutton="route('admin.orders.destroy-multiple')">
            <x-slot name="extrabuttonsdiv">
                @can('create-export')

                <x-admin.export-button
                    :route="route('admin.order-export')"
                    buttonId="exportOrderBtn"
...
@include('dashboard.shared.filter_js' , [ 'index_route' => route('admin.orders.index') ])
@endpush