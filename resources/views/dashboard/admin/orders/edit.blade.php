...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <i class="ti ti-password-user me-2"></i>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-9">
                <div class="card-body p-4">
                    <form class="form validated-form" method="POST" action="{{route('admin.orders.update' , ['order' => $row->id])}}" novalidate enctype="multipart/form-data">
                        @csrf
