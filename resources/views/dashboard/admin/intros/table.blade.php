        ...
        <tr class="delete_row">
            ...
            <td>
             ...
             <td>
                <x-admin.toggle
                    ...
                    url="{{ route('admin.intro-toggle',['intro' => $row->id ,'key' => 'is_active']) }}">
                </x-admin.toggle>
            </td>
            ...
            <td>
                <div class="d-inline-block text-nowrap">
                   @can('update-intro')
                    <a href="{{ route('admin.intros.edit', ['intro' => $row->id]) }}" class="btn btn-sm btn-icon"><i class="text-primary ti ti-edit"></i></a>
                   @endcan
                    <a href="{{ route('admin.intros.show' , ['intro' => $row->id])  }}" class="btn btn-sm btn-icon"><i class="text-info ti ti-eye-check"></i></a>
                   @can('delete-intro')
                    <a class="btn btn-sm btn-icon delete-row" data-url="{{ route('admin.intros.destroy', $row->id)  }}"><i class="text-danger ti ti-trash-x"></i></a>
                   @endcan
                </div>
            </td>
