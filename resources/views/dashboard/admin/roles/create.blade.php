        ...
        <div class="row g-0">
            ...
            <div class="col-md-9">
                <div class="card-body p-4">
                    <form class="form validated-form" method="POST" action="{{route('admin.roles.store')}}" novalidate
                                            ...
                                            <div class="card h-100">
                                                <div class="card-title px-2 d-flex justify-content-around mt-2"
                                                    ...
                                                    <div class="card-title mb-3">
                                                        <h5>@lang('trans.' . lcfirst($title) . '.index')</h5>
                                                    </div>
                                                ...
                                                <div class="card-body" style="padding: 15px;">
                                                    @foreach($permission as $key => $value)
                                                        <ul class="  mb-0">
                                                            <li class="mb-2 d-flex justify-content-between align-items-center   p-1 row text-center">
                                                                <div class="col-8">
                        ...
                        <div class="pt-4 d-flex justify-content-center mt-3">
                            ...
                            <a class="btn btn-label-dribbble waves-effect"
                               href="{{ url()->previous()}}">{{__('trans.back')}}</a>
                        </div>
                    </form>
                </div>
            </div>
