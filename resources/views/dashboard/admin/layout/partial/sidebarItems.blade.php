...
@can('read-all-intro')
<li class="menu-item @if(Route::currentRouteName() == 'admin.intros.index') active @endif">
    <a href="{{route('admin.intros.index')}}" class="menu-link">
        <i class="menu-icon tf-icons ti  ti-brand-swift"></i>
        <div data-i18n="@lang('trans.intros')">@lang('trans.intro.index')</div>
    </a>
</li>
@endcan
