...
@section('title')
    {{$title = __('trans.activityLog.index')}}
@endsection
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">  <i class="ti ti-abacus me-2"></i> {{$title}}</li>
        </ol>
    </nav>
            ...
            >
                <x-slot name="extrabuttonsdiv">
                    <a class=" me-1 btn btn-outline-info waves-effect extrabuttonsdiv "
                       href="{{route('admin.master-export', 'ActivityLog')}}"><i class="fa fa-file-excel-o"></i>
...
@push('js_files')
    ...
    @include('dashboard.shared.filter_js' , [ 'index_route' => route('admin.activity-log') ])
@endpush
